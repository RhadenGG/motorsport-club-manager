                ...
                <div class="msc-step-body">
                    ...
                    <div style="margin-bottom:20px;">
                        ...
                        <div class="msc-reg-grid-2">
                            <div class="msc-field">
                                <label>Name #1</label>
                                <input type="text" id="msc-pit-crew-1" value="<?php echo esc_attr(get_user_meta($user_id, 'msc_pit_crew_1', true)); ?>" placeholder="Optional">
                            </div>
                            <div class="msc-field">
                                <label>Name #2</label>
                                <input type="text" id="msc-pit-crew-2" value="<?php echo esc_attr(get_user_meta($user_id, 'msc_pit_crew_2', true)); ?>" placeholder="Optional">
                            </div>
                        </div>
                    </div>
