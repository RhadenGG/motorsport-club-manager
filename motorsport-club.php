...
require_once MSC_PATH . 'includes/class-msc-logger.php';
...
require_once MSC_PATH . 'includes/class-pricing.php';
...
require_once MSC_PATH . 'includes/class-frontend-dashboard.php';
...
function msc_get_account_url( $tab = '' ) {
    $base = get_option( 'msc_account_page_url', '' );
